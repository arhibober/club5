...
class nnElementToggler
{
	...
	function getInput( $name, $id, $value, $params, $children, $j15 = 0 )
	{
		...
		$document->addScript( JURI::root(true).'/plugins/system/nonumberelements/fields/toggler.js?v='.$this->_version );
		$document->addStyleSheet( JURI::root(true).'/plugins/system/nonumberelements/fields/style.css?v='.$this->_version );
