...
<div id="YoutubeGalleryMainContainer'.$videolist_row->id.'" style="position: relative;display: block;'.($show_player ? 'width:'.$width.'px;' : '').'">
';
//text-align:center;
		$result.='<div id="" style="'.($theme_row->cssstyle!='' ? $theme_row->cssstyle.';' : '').($show_player ? 'width:'.$width.'px;': '').' ">';
		...
		$result.=YoutubeGalleryLayoutRenderer::render($layoutcode, $videolist_row, $theme_row, $gallery_list, $width, $height, $videoid, $total_number_of_rows);
